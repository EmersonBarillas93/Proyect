...
##grafico de barras
ggplot(data=mtcars, aes(x=factor(gear)))+geom_bar()
...
ggplot(data=mtcars,aes(x=factor(gear), y=mpg))+geom_col()
...
##grafico de violin
ggplot(data=mtcars,aes(x=factor(gear), y=mpg))+geom_violin()
